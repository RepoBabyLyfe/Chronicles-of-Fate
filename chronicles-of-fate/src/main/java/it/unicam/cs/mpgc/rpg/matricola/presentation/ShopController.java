...
import it.unicam.cs.mpgc.rpg.matricola.domain.PlayerProfile;
import it.unicam.cs.mpgc.rpg.matricola.domain.Shop;
...
public class ShopController {
    ...
    private void onCardClicked(Card card) {
        ...
        boolean success = shop.buyCard(card, profile);
        ...
        if (success) {
            ...
            // Salviamo il profilo (non il combattimento!)
