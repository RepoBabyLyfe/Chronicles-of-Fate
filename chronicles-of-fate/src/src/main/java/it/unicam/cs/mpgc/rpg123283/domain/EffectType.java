...
/**
 * Definisce i tipi di effetti delle carte giocabili usando il Pattern Strategy.
 * Questo permette di mappare le logiche complesse da un file JSON senza usare reflection o script.
 */
