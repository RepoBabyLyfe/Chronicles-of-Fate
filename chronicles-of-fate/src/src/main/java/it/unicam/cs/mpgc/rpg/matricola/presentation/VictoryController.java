...
public class VictoryController {
    ...
    private void displayResult(CombatResult result) {
        if (result.isVictory()) {
            ...
            if (defeated < 3) {
                ...
                // Resettiamo i boss per la run successiva
    ...
    public void onPlayAgainClicked() {
        it.unicam.cs.mpgc.rpg.matricola.application.GameService service = SceneManager.getInstance().getGameService();
        it.unicam.cs.mpgc.rpg.matricola.domain.Character player = it.unicam.cs.mpgc.rpg.matricola.application.GameFactory.createPlayer();
        ...
        // oppure procediamo normalmente:
        it.unicam.cs.mpgc.rpg.matricola.domain.Character enemy = it.unicam.cs.mpgc.rpg.matricola.application.GameFactory.createEnemy(defeatedBosses);
