...
/**
 * Gestisce il ciclo di vita del combattimento: avvio, caricamento, fine,
 * e le azioni del giocatore durante lo scontro.
 */
public class CombatOrchestrator {
    ...
    /**
     * Adapter che traduce le notifiche del dominio in eventi dell'application
     * layer.
     * Questo permette al CombatManager di restare nel domain senza dipendere dagli
     * eventi.
     */
