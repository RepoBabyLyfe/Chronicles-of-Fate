...
public class PlayerProfile {
    ...
    public PlayerProfile(int initialFragments, Set<String> initialCards, int defeatedBosses) {
        this.etherFragments = initialFragments;
        //HashSet impedisce in automatico che ci siano nomi duplicati
    ...
    public PlayerProfile(int initialFragments, Set<String> initialCards) {
        this(initialFragments, initialCards, 0); //default per vecchi salvataggi o nuovi profili
    }
    ...
    public void resetDefeatedBosses() {
